const { getAllBlogs, renderSingleBlog, renderCreateBlogForm, renderEditBlogForm, deleteBlog, updateBlog } = require('../controllers/blog/blogControllers');
...
router.route("/edit/:id").get(renderEditBlogForm).post(updateBlog) // Assuming you want to handle the form submission here, adjust as necessary
